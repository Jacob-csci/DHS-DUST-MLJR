...
import tenserflow as tf # import the tensorflow package with an alias of tf
...
@app.route("/predict", mathods = ["POST"]) # set the predict.html route to /predict that accepts a POST request
def predict():
